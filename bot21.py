...
credentials["token"] = os.environ.get('1266550346:AAEw3NWVhd0JiUN9rFI0JBD545qOH_Ld-ls')
credentials["subreddit"] = os.environ.get('celeb')
credentials["channel"] = os.environ.get('redimgbot')
...
r = praw.Reddit(user_agent="Dank Doggo by Harsha :D", 
                client_id=os.environ.get('Candle4751'),
                client_secret=os.environ.get('_af3iBdcoirTa7kg92WPWcSUcAWQ_Q'),
                username=os.environ.get('nmnijilkhan'),
                password=os.environ.get('khannijil@123'))
r.read_only = True
